...
Refreshed at: `2026-08-24T21:18:30.183594+00:00`
...
- Branch: `master`
- Baseline commit: `9a5d4288d336` — status.sh: detect RUNNING via live session jsonl heartbeats
- Pending change set: 3 paths
  - `M  scripts/swarm/stop_wave.sh`
