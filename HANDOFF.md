...
Refreshed at: `2026-08-20T13:05:28.459100+00:00`
...
- Branch: `master`
- Baseline commit: `9d708178e9cd` — Grade at the frozen line, decide at kickoff: refresh pipeline, movement policy, promoted mapping
- Pending change set: 132 paths
  - `M  CURRENT_PREDICTIONS.md`
  - `M  HANDOFF.md`
  - `M  ROADMAP.md`
  - `M  artifacts/prospective/challengers.json`
  - `A  docs/data_source_scout_v4.md`
  - `A  docs/environmental_exposures.md`
  - `M  docs/findings.html`
  - `M  docs/forecast_weather_screen.md`
  - `A  docs/gdelt_backfill.md`
  - `M  docs/index.html`
  - `A  docs/interim_coach_screen.md`
  - `A  docs/movement_attribution.md`
  - `A  docs/opener_error_analysis.md`
  - `A  docs/penalty_crew_tendencies.md`
  - `A  docs/player_props_sourcing.md`
  - `A  docs/public_betting_battery_predeclaration.md`
  - `A  docs/public_betting_sourcing.md`
  - `A  docs/roof_decision_screen.md`
  - `A  docs/sagarin_backfill.md`
