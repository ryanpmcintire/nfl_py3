...
Refreshed at: `2026-08-20T15:46:06.543526+00:00`
...
- Branch: `master`
- Baseline commit: `41665872f510` — Fleet day: attribution answers what the market knows, four challengers go live
- Pending change set: 33 paths
  - `M  HANDOFF.md`
  - `M  README.md`
  - `M  ROADMAP.md`
  - `M  artifacts/prospective/challengers.json`
  - `A  docs/best_pick_big_spread_challenger.md`
  - `A  docs/drought_monitor_screen.md`
  ...
  - `A  docs/player_arrests_sourcing.md`
  - `M  docs/player_props_sourcing.md`
  - `M  docs/sagarin_backfill.md`
  - `A  registry/experiment_specs/environmental_battery_drought_severe_grass_opener.json`
  - `A  registry/experiments/experiment-run/20260820T151902Z.json`
  - `A  registry/experiments/experiment-run/20260820T152033Z.json`
  - `M  registry/weak_signals.json`
  - `M  scripts/build_environmental_exposure_join.py`
  - `A  scripts/compare_player_prop_snapshots.py`
  - `M  scripts/ingest_drought_monitor.py`
  - ...and 13 more
