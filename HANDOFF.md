...
Refreshed at: `2026-09-19T11:31:49.570709+00:00`
...
- Branch: `master`
- Baseline commit: `3d1e9672e0e7` — Disable paid odds captures, lock waits on the pool board only
- Pending change set: 2 paths
  - `M  HANDOFF.md`
  - `A  docs/lanes/free-odds-sources.md`
