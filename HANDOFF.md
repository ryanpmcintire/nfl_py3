...
Refreshed at: `2026-09-07T16:51:49.712845+00:00`
...
- Branch: `master`
- Baseline commit: `d300244640f7` — Binding: no unexplained threshold flips on the played card (owner order); MOD-18 lanes I (retire zone flip) and J (weak-spots table) launched [skip ci]
- Pending change set: 62 paths
  ...
  - `M  docs/index.html`
  - `M  docs/model.html`
  - `M  docs/overlay_leave_one_out.md`
  - `M  docs/overlay_subset_composition.md`
  - `M  docs/overlay_subset_holdout_v2.md`
  - `M  docs/spread_gap_zone_fade_overlay.md`
  - `A  docs/spread_gap_zone_retired.md`
  - `A  docs/spread_regime_program.md`
  - `A  registry/experiments/margin-backtest/20260907T160814Z.json`
  - `A  registry/experiments/margin-backtest/20260907T164310Z.json`
  - `A  registry/experiments/margin-predict/2026-week-01-20260907T160949Z.json`
  - `A  registry/experiments/margin-predict/2026-week-01-20260907T164352Z.json`
