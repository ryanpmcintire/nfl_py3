...
newSet: df = pd.read_csv(currentSeason) if currentSeason else pd.read_csv(newWeekPath)
...
opponent_names = regularSeason['team'].unique().tolist() + ['rai', 'sdg', 'ram', 'was']
verbose_names = regularSeason['verbose_name'].unique().tolist() + [
...
regularSeason[['Fav_City', 'Fav_Team', 'Fav_Spread']] = regularSeason[
    'Vegas_Line_Close'
].str.rsplit(' ', 2, expand=True)
...
regularSeason['HomeFav'] = (regularSeason['favorite'] == '000').map(
    {True: 0, False: -1}
)
regularSeason.loc[
    regularSeason['favorite'] == regularSeason['Home_Team'], 'HomeFav'
] = 1
regularSeason['underdog'] = (regularSeason['favorite'] == regularSeason['team']).map(
    {True: 0, False: 1}
)

regularSeason = regularSeason.fillna(0)
regularSeason['Home_Vegas_Spread'] = [
    regularSeason['Fav_Spread'][i]
    if regularSeason['HomeFav'][i] == 1
    else -1 * regularSeason['Fav_Spread'][i]
...
regularSeason['fourth_eff'] = np.where(
    regularSeason['fourth_eff'] == float('inf'),
    fourth_eff_avg,
    regularSeason['fourth_eff'],
)
regularSeason['fourth_def'] = np.where(
    regularSeason['fourth_def'] == float('inf'),
    fourth_def_avg,
    regularSeason['fourth_def'],
)
...
regularSeason['opponent_col'] = (
    regularSeason['boxscore_url']
    .groupby(regularSeason['boxscore_url'])
...
features.loc[
    features[(regularSeason['result'] == 'L') & (regularSeason['at'] == '')].index,
    'Home_Win',
] = 'L'
features.loc[
    features[(regularSeason['result'] == 'W') & (regularSeason['at'] == '')].index,
    'Home_Win',
] = 'W'
features.loc[
    features[(regularSeason['result'] == 'L') & (regularSeason['at'] == '@')].index,
...
features['Trail_Home_Score'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_score'],
    regularSeason['trail_score'],
)
...
features['Home_Allowed'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_allow'],
    regularSeason['trail_allow'],
)
...
features['Home_FTO'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_fto'],
    regularSeason['trail_fto'],
)
...
features['Home_Pass_Eff'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_pass_eff'],
    regularSeason['trail_pass_eff'],
)
...
features['Home_Pass_Def'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_pass_def'],
    regularSeason['trail_pass_def'],
)
...
features['Home_Rush_Eff'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_rush_eff'],
    regularSeason['trail_rush_eff'],
)
...
features['Home_Rush_Def'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_rush_def'],
    regularSeason['trail_rush_def'],
)
...
features['Home_Pen_Yds'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_penYds'],
    regularSeason['trail_penYds'],
)
...
features['Home_Pen_Yds_Agg'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_penYdsAgg'],
    regularSeason['trail_penYdsAgg'],
)
...
features['Home_Third_Eff'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_third_eff'],
    regularSeason['trail_third_eff'],
)
...
features['Home_Third_Def'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_third_def'],
    regularSeason['trail_third_def'],
)
...
features['Home_Fourth_Eff'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_fourth_eff'],
    regularSeason['trail_fourth_eff'],
)
...
features['Home_Fourth_Def'] = np.where(
    regularSeason['at'] == '@',
    regularSeason['trail_opp_fourth_def'],
    regularSeason['trail_fourth_def'],
)
