...
_FIXTURE_ROWS: tuple[tuple[int, int, int, int, int, int, bool, str, int, int], ...] = (
    (1, 2001, 1, 1, 2, 10, False, "2001-09-01", 30, 10),
    (2, 2001, 2, 2, 1, 20, False, "2001-09-08", 21, 24),
    (3, 2001, 3, 3, 4, 30, False, "2001-09-15", 7, 35),
    (4, 2001, 4, 4, 3, 40, False, "2001-09-22", 14, 28),
    (5, 2001, 5, 5, 1, 50, False, "2001-09-29", 17, 14),
    (10, 2002, 1, 1, 5, 99, True, "2002-08-31", 20, 17),
    (11, 2002, 2, 1, 3, 11, False, "2002-09-07", 31, 3),
    (12, 2002, 3, 1, 4, 11, False, "2002-09-14", 28, 21),
    (13, 2002, 1, 3, 2, 30, False, "2002-08-31", 10, 13),
    (14, 2002, 2, 4, 2, 40, False, "2002-09-07", 17, 20),
    (15, 2002, 4, 1, 2, 10, False, "2002-09-21", 24, 14),
    (16, 2002, 5, 2, 5, 99, True, "2002-09-28", 13, 10),
    (17, 2002, 6, 3, 2, 30, False, "2002-10-05", 21, 7),
    (18, 2002, 7, 4, 2, 40, False, "2002-10-12", 14, 10),
    (19, 2002, 8, 5, 2, 50, False, "2002-10-19", 30, 20),
    (20, 2002, 9, 2, 3, 20, False, "2002-10-26", 35, 14),
    (21, 2002, 10, 3, 2, 30, False, "2002-11-02", 17, 16),
    (22, 2002, 11, 3, 4, 30, False, "2002-11-09", 20, 17),
)
