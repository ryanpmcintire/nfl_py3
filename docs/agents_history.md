# AGENTS.md history (moved 2026-09-12)

This is the full AGENTS.md as it stood before the 2026-09-12 rewrite to rules only. Every rule in it still binds; the dated incident narratives, corrections and superseded pool readings live here so the file every session loads stays small. Re-run commands for current numbers rather than quoting anything below.
