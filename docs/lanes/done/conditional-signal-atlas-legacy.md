> Historical snapshot saved 2026-09-21. This lane describes independent pick flips, not contributions to the current fitted probability. Its serving and next-step recommendations are superseded by ../conditional-signal-atlas.md.
