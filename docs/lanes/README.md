...
- [sim04-play-simulator](done/sim04-play-simulator.md) - 2026-09-26: DONE. Engine, team conditioning, LOSO grade (raw refuted, side split unresolved), SIM-05 what-ifs, dashboard chart; see docs/sim04_unit_log.md.
