...
- [conditional-signal-atlas](conditional-signal-atlas.md) — MOD-19: first fitted-signal family implemented in Findings with paired refits, four predeclared groups and three evaluation views; expand to individual signals and other dimensions next
