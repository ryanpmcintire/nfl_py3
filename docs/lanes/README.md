...
- [conditional-signal-atlas](conditional-signal-atlas.md) — MOD-19: recovered and saved the approved mockup; Findings now follows its layout with working chart/season selection. First combined-situation family remains the only measured family; individual signals are next.
