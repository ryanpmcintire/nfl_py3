...
| LEAD-36 | 🔬 | Open-corner stadium wind | Buffalo/Chicago/Foxboro-style open geometries amplify sustained wind into passing suppression. Predeclared direction: take the UNDERDOG in high-wind games at open-corner venues. Venue interaction is new vs the battery's venue-blind wind cells. |
| LEAD-37 | 🔬 | Rain-on-grass fumble chaos | Wet natural surfaces spike fumbles; chaos favors dogs. Predeclared direction: take the UNDERDOG in rain-on-grass games. ATS chaos-framing is new (the screened precip×total cell is a totals-market result — different market, not poolable). |
| LEAD-38 | 🔬 | Snow-game home preparation | Equipment, routine, and footing familiarity in snow. Predeclared direction: BACK home teams in snow games. Rare; record regardless of width. |
