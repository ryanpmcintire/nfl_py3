...
| LEAD-21 | 🔬 | Post-overtime fatigue | OT teams log ~15–25 extra snaps on short recovery and underperform the next week. Predeclared direction: FADE post-OT teams. The travel/rest battery never isolated OT; declare fresh, opener grade. |
| LEAD-22 | 🔬 | Monday-night-road short week | Monday ROAD teams playing the following Sunday eat travel plus a six-day week plus a late night. Predeclared direction: FADE. Narrower than the screened `short_week_road` cell (MNF-road only, travel compound); cite the parent cell in the predeclaration. |
...
| LEAD-40 | 🔬 | Home-Thursday rest compound | Home Thursday teams (no travel, short prep both sides) vs road Thursday teams off Sunday travel. Predeclared direction: BACK home-Thursday teams. Home/road split is new vs the screened Thursday-pure cell. |
...
| LEAD-58 | ⬜ | Snap-weighted age curves | Build age×position performance curves from snap history (feeds XLG-06 priors and the rookie-wall lead). No ATS direction (QUALITY infrastructure). Done when curves plus split-half reliability ship as an artifact + doc. |
