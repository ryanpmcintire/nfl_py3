...
| UI-16 | ⬜ | Board assistant (static guided) | Chat panel over publish-time-generated knowledge (picks, model, findings, glossary) with client-side retrieval only — no LLM, no backend, nothing that breaks static Pages hosting. Scouted `docs/board_assistant_scout.md` (options graded, work packages A1-A4, guardrails). Ready to build. |
