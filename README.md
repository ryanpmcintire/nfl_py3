...
- **Weak-signal registry:** 7,052 results recorded -- 6,992 unresolved_below_power, 60 closed (52 refuted_mechanism, 8 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
