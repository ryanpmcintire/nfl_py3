...
- **Weak-signal registry:** 5,077 results recorded -- 5,048 unresolved_below_power, 29 closed (29 refuted_mechanism, 0 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
...
- **Prospective challengers:** 50 of 56 registered challengers are actively tracked prospectively (`artifacts/prospective/challengers.json`).
<!-- RESEARCH_STATE:END -->
