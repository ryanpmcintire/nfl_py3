...
- **Weak-signal registry:** 7,052 results recorded -- 6,991 unresolved_below_power, 61 closed (52 refuted_mechanism, 9 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
