...
- **Weak-signal registry:** 696 results recorded -- 692 unresolved_below_power, 4 closed (4 refuted_mechanism, 0 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
- **Rotation registry:** 398 declared research families -- 33 open, 0 confirmed/closed/retired, 365 declared for coverage only (no window yet).
