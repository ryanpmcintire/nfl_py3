...
- **Weak-signal registry:** 4,614 results recorded -- 4,595 unresolved_below_power, 19 closed (19 refuted_mechanism, 0 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
