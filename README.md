...
- **Weak-signal registry:** 4,564 results recorded -- 4,543 unresolved_below_power, 21 closed (21 refuted_mechanism, 0 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
