...
- **Weak-signal registry:** 6,988 results recorded -- 6,940 unresolved_below_power, 48 closed (44 refuted_mechanism, 4 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
