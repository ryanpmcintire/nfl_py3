...
- **Weak-signal registry:** 6,710 results recorded -- 6,663 unresolved_below_power, 47 closed (43 refuted_mechanism, 4 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
