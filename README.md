...
- **Weak-signal registry:** 7,042 results recorded -- 6,985 unresolved_below_power, 57 closed (50 refuted_mechanism, 7 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
