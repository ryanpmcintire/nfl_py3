...
Active model: `market_residual` with `weak_stack` features (`3ccf838f9a304dcd`), regressor `ridge`, ridge alpha `10.0`, calibration `none`.
...
- **Weak-signal registry:** 4,143 results recorded -- 4,134 unresolved_below_power, 9 closed (9 refuted_mechanism, 0 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
