...
- **Weak-signal registry:** 6,995 results recorded -- 6,944 unresolved_below_power, 51 closed (47 refuted_mechanism, 4 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
