...
Active model: `market_residual` with `weak_stack` features (`d1f07d773475dc58`), regressor `ridge`, ridge alpha `10.0`, calibration `none`.
...
- Close-graded accuracy (secondary -- the market's sharpest, and least representative, decision point): **52.10%** (1,081 of 2,075 non-push games), week-blocked 95% interval [50.12%, 54.24%].
