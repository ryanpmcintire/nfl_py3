...
- **Weak-signal registry:** 7,031 results recorded -- 6,977 unresolved_below_power, 54 closed (50 refuted_mechanism, 4 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
