...
- **Weak-signal registry:** 1,678 results recorded -- 1,669 unresolved_below_power, 9 closed (9 refuted_mechanism, 0 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
