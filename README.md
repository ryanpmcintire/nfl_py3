...
- **Weak-signal registry:** 7,272 results recorded -- 7,203 unresolved_below_power, 69 closed (60 refuted_mechanism, 9 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
