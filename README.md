...
- **Weak-signal registry:** 7,251 results recorded -- 7,188 unresolved_below_power, 63 closed (54 refuted_mechanism, 9 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
