...
- **Weak-signal registry:** 780 results recorded -- 774 unresolved_below_power, 6 closed (6 refuted_mechanism, 0 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
...
- **Prospective challengers:** 36 of 42 registered challengers are actively tracked prospectively (`artifacts/prospective/challengers.json`).
<!-- RESEARCH_STATE:END -->
