...
- **Weak-signal registry:** 5,225 results recorded -- 5,195 unresolved_below_power, 30 closed (30 refuted_mechanism, 0 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
