...
- **Weak-signal registry:** 7,022 results recorded -- 6,969 unresolved_below_power, 53 closed (49 refuted_mechanism, 4 bounded_by_control). An interval crossing zero is never by itself grounds to close a line of work; see `AGENTS.md`.
