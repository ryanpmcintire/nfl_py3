"""Standalone weekly recorder for the ``special_teams_return_tilt_overlay`` challenger.
...
``nfl_ats.special_teams_return_tilt_overlay.record_special_teams_return_tilt_challenger_decisions``
...
Usage (from the repo root, per AGENTS.md environment conventions)::
    ...
    .\\.tools\\uv.exe run --no-sync python scripts/record_special_teams_return_challenger.py
"""
