...
def normalize_event_odds(
    ...
    *,
    ...
    if (
        frame["bookmaker_last_update_utc"].gt(frame["snapshot_requested_at_utc"]).any()
        or frame["market_last_update_utc"].gt(frame["snapshot_requested_at_utc"]).any()
    ):
        raise ApiAbort("bookmaker/market update timestamp exceeds the requested snapshot timestamp")
