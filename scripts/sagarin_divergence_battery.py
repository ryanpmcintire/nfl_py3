...
def block_bootstrap_two_group(
    ...
    *,
    ...
    """Vectorized joint week-blocked bootstrap of ``100*(subset_mean-complement_mean)``.

    Reused verbatim (same algorithm) from ``scripts/nfl_weather_battery_screen.py::
    block_bootstrap_two_group`` (itself reused from ``nfl_bias_battery_screen.py``).
    """
